...
if (NOT PLUGIN_FIREFOX_EXTENSION_ID)
    set(PLUGIN_FIREFOX_EXTENSION_ID "${PLUGIN_CRX_ID}@${COMPANY_DOMAIN}")
endif()

if (PLUGIN_FIREFOX_ALLOWED_ORIGINS)
    string(REPLACE ";" "~'~, ~'~" PLUGIN_FIREFOX_ALLOWED_ORIGINS "${PLUGIN_FIREFOX_ALLOWED_ORIGINS}")
    set(PLUGIN_FIREFOX_ALLOWED_ORIGINS "~'~${PLUGIN_FIREFOX_ALLOWED_ORIGINS}~'~")
else()
    set(PLUGIN_FIREFOX_ALLOWED_ORIGINS "~'~${PLUGIN_CRX_ID}@${COMPANY_DOMAIN}~'~")
endif()
