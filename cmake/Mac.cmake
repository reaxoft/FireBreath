...
MACRO(add_mac_plugin PROJECT_NAME PLIST_TEMPLATE STRINGS_TEMPLATE LOCALIZED_TEMPLATE INSOURCES)
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND} -D INFILE="${CMAKE_CURRENT_BINARY_DIR}/gen/fwh-chrome-manifest.json"
                                 ...
                                 -P ${CFGFILE_SCRIPT}
        COMMAND ${CMAKE_COMMAND} -D INFILE="${CMAKE_CURRENT_BINARY_DIR}/gen/fwh-firefox-manifest.json"
                                 -D OUTFILE="$<TARGET_FILE_DIR:${PROJECT_NAME}>/../Resources/fwh-firefox-manifest.template"
                                 -D NAMESHOST="_FILEPATH_"
                                 -P ${CFGFILE_SCRIPT}
